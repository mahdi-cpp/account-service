...
type AppManager struct {
	mu             sync.RWMutex
	collection     *collection_manager_memory.Manager[*user.User]
	collectionJson *collection_manager_json.Manager[*user.User]
	//rdb        *redis.Client
	ctx      context.Context
...
func New() (*AppManager, error) {
	...
	var err error
	manager.collection, err = collection_manager_memory.New[*user.User](config.RootDir)
	if err != nil {
